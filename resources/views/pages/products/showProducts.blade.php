<x-main-layout>
 ...
 <div class="p-5 my-5 mx-10 w-1/2">
...
<div>
   <div class="m-3">
         ...
         <h1 class="text-gray-600">Description : {{  $product->description }} </h1>
         <h1 class="text-gray-600">status : <span class="text-green-500">{{  $product->status }}</span>  </h1>
    ...
    <div class="flex flex-col items-start">
      ...
      @if ($product->discount >= 1)
       <div class="bg-red-500 p-2 rounded-full absolute top-2 left-2 text-white font-bold text-sm opacity-90"> Off % {{ $product->discount }}</div>
          
      @endif

       <div class="grid grid-cols-2 gap-2 my-3  text-sm text-white mx-5">
